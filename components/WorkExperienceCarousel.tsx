    ...
    >
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="relative flex-1">
          <Image alt="" src={imgChartBg} width={400} height={180} loading="lazy" className="absolute inset-0 w-full h-full object-fill" />
          <div className="absolute" style={{ top: '10px', left: '2px', right: 0, bottom: '18px', overflow: 'hidden' }}>
            <Image alt="" src={imgChartLine} width={400} height={160} loading="lazy" className="w-full h-full object-fill" />
    ...
    >
      ...
      <div className="flex items-center justify-between py-[1px]">
        <div className="flex gap-3 items-center">
          <Image alt="Miles Rand" src={imgMilesPhoto} width={36} height={36} loading="lazy" className="w-9 h-9 rounded-full object-cover shrink-0" />
        ...
        <Image alt="Fleetio" src={imgFleetio} width={77} height={40} loading="lazy" className="h-10 w-[77px] object-contain shrink-0" />
      </div>
    </div>
  )
}
        ...
        <div key={t.label} className="flex flex-col gap-[6px]">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-[6px] flex items-center justify-center shrink-0" style={{ background: t.bg }}>
              <Image alt="" src={t.icon} width={24} height={24} loading="lazy" className="w-6 h-6 object-contain" />
            </div>
