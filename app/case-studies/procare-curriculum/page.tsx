...
function ClickToPlayVideo({ thumbnailSrc, embedSrc }: { thumbnailSrc: string; embedSrc: string }) {
  ...
  return (
    <div style={{ ...wrapStyle, cursor: 'pointer' }} onClick={() => setPlaying(true)}>
      <Image src={thumbnailSrc} alt="Video thumbnail" width={1440} height={900} loading="lazy" className="object-cover" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }} />
            ...
            <div className="flex-1 min-w-0 max-w-[842px] flex flex-col divide-y divide-[var(--color-system-border)]">
              ...
              <section className="pb-10">
                ...
                <FadeUp className="flex items-center gap-3 mb-6">
                  <Image src={imgProcareLogo} alt="Procare" width={20} height={20} priority className="w-5 h-5 object-contain opacity-70" />
                ...
                <FadeUp delay={0.1} className="mb-6">
                  <div className="rounded-[12px] overflow-hidden w-full">
                    <Image src={imgHero} alt="Procare curriculum platform" width={1440} height={900} priority className="w-full object-cover" />
                  </div>
                </FadeUp>
              ...
              <section id="problem" className="py-10">
                ...
                <FadeUp>
                  <div className="w-full overflow-hidden rounded-[8px]">
                    <Image src={imgProblems} alt="Three broken systems" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                  </div>
                </FadeUp>
              </section>
              ...
              <section id="discovery" className="py-10">
                ...
                <FadeUp className="mb-4">
                  <div className="w-full overflow-hidden rounded-[8px]">
                    <Image src={imgDiscovery1} alt="Discovery research" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                  </div>
                </FadeUp>

                <FadeUp>
                  <div className="w-full overflow-hidden rounded-[8px]">
                    <Image src={imgDiscovery2} alt="Assumptions mapping" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                  </div>
                </FadeUp>
              </section>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <DesignChapterBlock badgeNumber="Design 01" title="Curriculum Data Architecture — Making 4,000 Lessons Useful">
                      ...
                      <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="w-full md:w-[45%]">
                          <Image src={imgDataArch} alt="Curriculum data architecture" width={800} height={600} loading="lazy" className="w-full object-cover rounded-[8px]" />
                        </div>
                      </div>
                    </DesignChapterBlock>
                  </FadeUp>
                  ...
                  <FadeUp>
                    <DesignChapterBlock badgeNumber="Design 02" title="Weekly Lesson Planner">
                      ...
                      <div className="border border-[var(--color-system-border)] rounded-[6px] overflow-hidden">
                        <Image src={imgLessons} alt="Weekly lesson planner" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                      </div>
                      <Caption>
                    ...
                    <DesignChapterBlock badgeNumber="Design 03" title="Lesson Detail & Custom Builder">
                      ...
                      <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="w-full md:w-[38%]">
                          <Image src={imgLessonDetail} alt="Lesson detail and custom builder" width={800} height={600} loading="lazy" className="w-full object-cover rounded-[8px]" />
                        </div>
                      </div>
                    </DesignChapterBlock>
                  </FadeUp>
                  ...
                  <FadeUp>
                    <DesignChapterBlock badgeNumber="Design 05" title="Observation & Assessment Workflow Built from Scratch">
                      ...
                      <div className="w-full overflow-hidden rounded-[8px] mb-3">
                        <Image src={imgAssessment} alt="Assessment workflow" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                      </div>
                      <Caption>
                      ...
                      <div className="w-full overflow-hidden rounded-[8px] mt-6">
                        <Image src={imgTeacherFlow} alt="Teacher observation flow" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                      </div>
                    </DesignChapterBlock>
                  </FadeUp>
                  ...
                  <FadeUp>
                    <DesignChapterBlock badgeNumber="Design 05" title="Portfolio Generation & Parent Communication">
                      ...
                      <div className="w-full overflow-hidden rounded-[8px] mb-3">
                        <Image src={imgPortfolioSend} alt="Portfolio sending flow" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                      </div>
                      <Caption>
                  ...
                  <FadeUp>
                    <DesignChapterBlock badgeNumber="Design 06" title="In-Product Upsell & LBP Landing Page">
                      ...
                      <div className="w-full overflow-hidden rounded-[8px]">
                        <Image src={imgLbpMarketing} alt="LBP marketing landing page" width={1440} height={900} loading="lazy" className="w-full object-cover" />
                      </div>
                    </DesignChapterBlock>
                  </FadeUp>
                ...
                <div className="bg-[var(--color-system-white)] border border-[var(--color-system-border)] rounded-[6px] px-4 py-5 flex flex-col gap-5">
                  ...
                  <div className="flex items-start justify-between">
                    <a href="https://www.linkedin.com/in/stephenanastasi/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                      <Image src="/rec-stephen.jpg" alt="Stephen Anastasi" width={40} height={40} loading="lazy" className="w-10 h-10 rounded-full object-cover flex-shrink-0" />
                      <div>
                    ...
                    <Image src="/assets/06c24fb7-f2ec-4e83-8247-d40dfdb20e2f.png" alt="" width={77} height={40} loading="lazy" className="h-10 w-[77px] object-contain" />
                  </div>
                </div>
              </section>
