    ...
    <div className="flex min-h-screen bg-[var(--color-system-background)]">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="px-10 py-4 border-b border-[var(--color-system-border)] flex items-center gap-2">
          ...
          <div className="h-3 w-64 bg-[var(--color-system-background-02)] animate-pulse rounded" />
        </div>
          ...
          <div className="flex gap-[40px] items-start">
            ...
            <div className="flex-1 min-w-0 max-w-[842px] flex flex-col gap-6 pr-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="h-3 w-36 bg-[var(--color-system-background-02)] animate-pulse rounded" />
              </div>
              <div className="h-12 w-3/4 bg-[var(--color-system-background-02)] animate-pulse rounded" />
              {/* Hero image */}
              <div className="h-[340px] w-full bg-[var(--color-system-background-02)] animate-pulse rounded-xl" />
              {/* Meta cards row */}
              ...
              <div className="h-[260px] w-full bg-[var(--color-system-background-02)] animate-pulse rounded" />
            </div>
          </div>
        </div>
      </div>
