            ...
            <div className="flex-1 min-w-0 max-w-[842px] flex flex-col divide-y divide-[var(--color-system-border)]">
              ...
              <section className="pb-10">
                ...
                <FadeUp className="flex items-center gap-3 mb-6">
                  <Image src={imgMmLogo} alt="Milk Moovement" width={20} height={20} className="object-contain opacity-70" />
                ...
                <FadeUp delay={0.1} className="mb-6">
                  <div className="rounded-[12px] overflow-hidden w-full">
                    <Image src={imgHero} alt="Milk Moovement platform interface" width={1672} height={941} className="w-full h-auto object-cover" />
                  </div>
                </FadeUp>
              ...
              <section id="overview" className="py-10">
                ...
                <FadeUp>
                  <div className="w-full overflow-hidden">
                    <Image src={imgOverview} alt="Dairy supply chain overview" width={1020} height={435} className="w-full h-auto object-cover" />
                  </div>
                </FadeUp>
              </section>
                ...
                <FadeUp className="flex flex-col gap-3 mb-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex-1 min-w-0 bg-[var(--color-system-white)] border border-[var(--color-system-border)] rounded-[12px] px-6 py-4 flex flex-col gap-3">
                      ...
                      <div className="relative h-[220px] overflow-hidden rounded-[4px]">
                        <Image src={imgUserInterviews} alt="User Interviews" fill className="object-cover" />
                      </div>
                    ...
                    <div className="flex-1 min-w-0 bg-[var(--color-system-white)] border border-[var(--color-system-border)] rounded-[12px] px-6 py-4 flex flex-col gap-3">
                      ...
                      <div className="relative h-[220px] overflow-hidden rounded-[4px]">
                        <Image src={imgExistingUiAudit} alt="Existing UI Audit" fill className="object-cover" />
                      </div>
                      <p className="text-[11px] leading-[16px] text-[var(--color-system-text-primary)] tracking-[0.03px]">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <div className="flex-1 min-w-0 bg-[var(--color-system-background-02)] border border-[var(--color-system-border)] rounded-[12px] px-6 py-4 flex flex-col gap-3">
                      ...
                      <div className="relative h-[220px] overflow-hidden rounded-[4px]">
                        <Image src={imgDatadogAnalysis} alt="Datadog Analysis" fill className="object-cover" />
                      </div>
                      <p className="text-[11px] leading-[16px] text-[var(--color-system-text-primary)] tracking-[0.03px]">
                    ...
                    <div className="flex-1 min-w-0 bg-[var(--color-system-background-02)] border border-[var(--color-system-border)] rounded-[12px] px-6 py-4 flex flex-col gap-3">
                      ...
                      <div className="relative h-[220px] overflow-hidden rounded-[4px] bg-[#cde7fa]">
                        <Image src={imgUsagePatterns} alt="Usage Patterns" fill className="object-cover rounded-[5px]" />
                      </div>
                      <p className="text-[11px] leading-[16px] text-[var(--color-system-text-primary)] tracking-[0.03px]">
              ...
              <section id="requirements" className="py-10">
                ...
                <FadeUp className="mb-6">
                  <div className="w-full overflow-hidden">
                    <Image src={imgNavRedesign} alt="Navigation redesign" width={1555} height={1920} className="w-full h-auto object-cover" />
                  </div>
                </FadeUp>
              ...
              <section id="designs" className="py-10">
                ...
                <FadeUp className="mb-6">
                  <div className="bg-[rgba(0,163,246,0.12)] border border-[#00a3f6] rounded-[6px] px-6 py-5 flex flex-col md:flex-row gap-5 items-start md:items-center">
                    <div className="relative w-full md:w-[315px] h-[155px] border-2 border-[var(--color-system-text-primary)] overflow-hidden">
                      <Image src={imgCalloutScreenshot} alt="Navigation screenshot" fill className="object-cover" />
                    </div>
                ...
                <FadeUp className="mb-10">
                  <div className="bg-[var(--color-system-white)] rounded-[12px] px-6 py-4 flex flex-col gap-5">
                    ...
                    <div className="w-full overflow-hidden rounded-[4px]">
                      <Image src={imgUnifiedPatterns} alt="Unified Patterns & Better Visibility" width={1920} height={875} className="w-full h-auto object-cover" />
                    </div>
                    <p className="text-[14px] leading-[22px] text-[var(--color-system-text-primary)]">
                ...
                <FadeUp className="flex flex-col md:flex-row gap-10 mb-6">
                  <div className="flex-1 min-w-0 bg-[var(--color-system-white)] rounded-[12px] px-6 py-4 flex flex-col gap-3">
                    ...
                    <div className="w-full overflow-hidden rounded-[4px]">
                      <Image src={imgColumnCustom} alt="Column Customization" width={1326} height={660} className="w-full h-auto object-cover" />
                    </div>
                    <p className="text-[14px] leading-[22px] text-[var(--color-system-text-primary)]">
                  ...
                  <div className="flex-1 min-w-0 bg-[var(--color-system-white)] rounded-[12px] px-6 py-4 flex flex-col gap-3">
                    ...
                    <div className="w-full overflow-hidden rounded-[4px]">
                      <Image src={imgEnhanceCustom} alt="Enhanced Filters and Date" width={1326} height={660} className="w-full h-auto object-cover" />
                    </div>
                    <p className="text-[14px] leading-[22px] text-[var(--color-system-text-primary)]">
                ...
                <div className="bg-[var(--color-system-white)] border border-[var(--color-system-border)] rounded-[6px] px-4 py-5 flex flex-col gap-5">
                  ...
                  <div className="flex items-start justify-between">
                    <a href="https://www.linkedin.com/in/kenny-harris-50b664163/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                      <Image src="/rec-kenny.jpg" alt="Kenny Harris" width={40} height={40} className="rounded-full object-cover flex-shrink-0" />
                      <div>
                    ...
                    <Image src="/assets/90abaedd-e76b-4630-ac8b-5f063ecad828.png" alt="Spellbook" width={77} height={40} className="object-contain" />
                  </div>
                </div>
              </section>
              ...
              <FadeUp>
                <div className="py-6 flex flex-col items-center gap-3">
                  <Image src="/Moorice_Dab_output.gif" alt="Moorice celebrating" width={750} height={750} className="w-[50%] h-auto" unoptimized />
